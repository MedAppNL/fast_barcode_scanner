...
class StaticMaterialPreviewOverlayState extends State<MaterialPreviewOverlay> {
  ...
  Widget build(BuildContext context) {
    final borderColor =
        widget.onScannedBoundsColor?.call(_filteredBarcodes) ?? widget.cutOutBorderColor;
...
class MaterialPreviewOverlayState extends State<MaterialPreviewOverlay>
  ...
  void initState() {
    ...
    final opacitySequence = TweenSequence([
      ...
      TweenSequenceItem(
          tween: Tween(begin: 1.0, end: 0.0).chain(CurveTween(curve: Curves.easeOutCubic)),
          weight: expand),
  ...
  Widget build(BuildContext context) {
    final borderColor =
        widget.onScannedBoundsColor?.call(_filteredCodes) ?? widget.cutOutBorderColor;
